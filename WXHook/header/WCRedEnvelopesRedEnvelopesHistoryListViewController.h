...
@end
@interface WCRedEnvelopesRedEnvelopesHistoryListViewController : WCRedEnvelopesBaseViewController
{
    id <WCRedEnvelopesRedEnvelopesHistoryListViewControllerDelegate> m_delegate; // [m_delegate OnLoadMoreRedEnvelopesList]加载更多红包记录
