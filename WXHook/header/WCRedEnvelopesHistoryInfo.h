...
{
    long long m_lRecTotalNum; // 收到红包
    long long m_lRecTotalAmount; // 收到总的钱数 单位为分
    long long m_lSendTotalNum; // 发送的总红包树
    long long m_lSendTotalAmount; // 发送的总钱数 单位为分
    long long m_lTotalGameCount; // 手气最佳
    NSMutableArray *m_arrRecList; // WCRedEnvelopesReceivedRedEnvelopesInfo
